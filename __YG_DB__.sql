...
CREATE TABLE IF NOT EXISTS `yg_allbrand` (
...
CREATE TABLE IF NOT EXISTS `yg_brand` (
...
(44, 'WS', '初语', 'images/jackwolfskin507637659.jpg');
...
CREATE TABLE IF NOT EXISTS `yg_floor` (
...
CREATE TABLE IF NOT EXISTS `yg_product` (
...
CREATE TABLE IF NOT EXISTS `yg_prowall` (
...
CREATE TABLE IF NOT EXISTS `yg_user` (
